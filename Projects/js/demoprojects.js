...
//$('#itpdiv', window.parent.document).delay(200).load('TotalProject.php');
}
...
{ 
	this.editableGrid = new EditableGrid("ProjectData", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("loaddataprojects.php?db_tablename=ProjectData");
};
