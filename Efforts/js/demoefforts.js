...
function updateCellValue(editableGrid, rowIndex, columnIndex, oldValue, newValue, row, onResponse)
	{
var popid=$('#filter', parent.document.iframes_a).val();
$('#ipdiv', parent.document.iframes_a).delay(400).load('Effortfilter.php', {pid: popid});   
                $.ajax({
		url: 'updateeffort.php',
		type: 'POST',
		dataType: "html",
	   		data: {
...
{ 
	this.editableGrid = new EditableGrid("EffortDetails", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("loaddataefforts.php?db_tablename=EffortDetails");
};
