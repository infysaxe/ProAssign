...
//$('#iediv', window.parent.document).delay(200).load('../Projects/TotalProject.php');
}
...
{ 
	this.editableGrid = new EditableGrid("EmployeeData", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("loaddata.php?db_tablename=EmployeeData");
};
